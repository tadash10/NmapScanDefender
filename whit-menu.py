...
def print_menu():
    print("\n--- Nmap Defender Menu ---")
    print("1. Start Nmap Defender")
    print("2. Whitelist IP Address")
    print("3. Set Rate Limit for IP Address")
    print("4. Quit")
...
def handle_menu_choice(choice):
    if choice == '1':
        ...
        ip_address = input("Enter the IP address to whitelist: ")
        whitelist_ip_address(ip_address)
    elif choice == '3':
        ip_address = input("Enter the IP address to set rate limit: ")
        limit = int(input("Enter the rate limit (connections per minute): "))
        rate_limit_ip_address(ip_address, limit)
    elif choice == '4':
        sys.exit("Exiting Nmap Defender...")
    else:
...
def print_disclaimer():
    print("Disclaimer: Use this script at your own risk. The author and the organization are not responsible for any misuse or damage caused by this script.")
